# src/models/torchseg/postprocessor.py: convert a torchvision segmentation mask into corners
...
class TorchsegPostprocessor(BasePostprocessor):
    """Thresholds mask logits and returns standard corners via independent contour extraction."""
